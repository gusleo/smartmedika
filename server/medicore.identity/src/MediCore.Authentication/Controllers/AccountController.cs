...
namespace MediCore.Authentication.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        private readonly dna.core.auth.IAuthenticationService _authServices;
        ...
        public async Task<IActionResult> Login(string returnUrl = null)
        {
            ...
            // await _authServices.InitRoleAndUser();
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _authServices.Login(new LoginModel {Username = model.Email, Password = model.Password, RememberLogin = model.RememberMe}, lockoutOnFailure: false);
                if (result.Succeeded)
                {

                    var user = await _userManager.FindByNameAsync(model.Email);
                    if ( !await _authServices.IsEmailConfirmedAsync(user.Id.ToString()))
                    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var result = await _authServices.Register(new RegisterModel { 
                    ...
                    ConfirmPassword = model.ConfirmPassword},  true, true);
