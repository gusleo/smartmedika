...
{
    public class HospitalImageRepository : EntityReadWriteBaseRepository<HospitalImage>, IHospitalImageRepository
    {
        public IMediCoreContext MediCoreContext
        {
            get { return _context as IMediCoreContext; }
        }
        public HospitalImageRepository(IMediCoreContext context) : base(context)
        {
