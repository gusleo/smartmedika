...
{
    public class PolyClinicSpesialistMapRepository : EntityReadWriteBaseRepository<PolyClinicSpesialistMap>, IPolyClinicSpesialistMapRepository
    {
        ...
        public PolyClinicSpesialistMapRepository(IMediCoreContext context) : base(context)
        {
        }
