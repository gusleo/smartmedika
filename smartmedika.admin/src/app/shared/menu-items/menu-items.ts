...
const MENUITEMS = [
  ...
  },*/
  {
    ...
    icon: 'today',
    children: [
      {state: 'list', name: 'Daftar Appointment'},
  ...
  },
  {
    ...
    icon: 'local_hospital',
    children: [
      {state: 'list', name: 'Daftar Klinik'},
      {state: 'register', name: 'Register Klinik'},
    ]
  },
  {
    state: 'doctor',
    ...
    icon: 'person_pin',
    children: [
      {state: 'list', name: 'Daftar Dokter'},
      {state: 'list-register', name: 'Verifikasi Daftar Dokter'},      
      {state: 'list-doctor-admin', name: 'Daftar Dokter By Admin'},            
      {state: 'register', name: 'Register Dokter'},
    ]
  },
  {
    state: 'blogs',
  ...
  },
  {
    ...
    icon: 'settings',
    children: [
      {state: 'polyclinic', name: 'Poliklinik'},
      {state: 'specialist', name: 'Spesialis'},
      {state: 'country', name: 'Negara'},
      {state: 'region', name: 'Provinsi'},
      {state: 'regency', name: 'Kabupaten'},
    ]
  }      
];
